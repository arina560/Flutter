...
class CourseScope extends InheritedWidget{
  ...
  CourseScope({super.key, required super.child});
  ...
  static CourseScope of(BuildContext context){
    final result = context.dependOnInheritedWidgetOfExactType<CourseScope>();
    assert(result != null, 'No CourseCatalog found in context');
    return result!;
  }

  @override
  bool updateShouldNotify(CourseScope oldWidget) {
